...
namespace Herald
{
    ...
    public sealed partial class App : Application
    {
        ...
        public App()
        {
            current = DateTime.Now.Subtract(new TimeSpan(TimeSpan.TicksPerHour));
            this.User = new HeraldUser();
            this.InitializeComponent();
            this.Suspending += this.OnSuspending;
            Windows.Storage.ApplicationDataContainer localSettings = Windows.Storage.ApplicationData.Current.LocalSettings;
            if (localSettings.Values.ContainsKey("UUID"))
                User.UUID = localSettings.Values["UUID"].ToString();
            if (localSettings.Values.ContainsKey("userID"))
                User.userID = localSettings.Values["userID"].ToString();
        }
